...
import { SPI } from 'spi';
import { ST7735 } from './lib/ST7735';
import font from './font-lee-sans';
// const image = require('@kaluma/logo-mono');
const s = board.spi(0);
const st7735 = new ST7735(s, {
  width: 128,
  height: 128,
  xstart: 2,
  ystart: 3,
...
const gc = st7735.getBufferedContext();
const t = 0;
...
const xxx = gc.measureText('ff');

const image = {
  width: 10,
  height: 10,
  bpp: 16,
  data: ""
};
